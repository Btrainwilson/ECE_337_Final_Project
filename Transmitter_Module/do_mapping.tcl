...
analyze -format sverilog -lib WORK {flex_pio_si.sv USB_Timer.sv flex_counter.sv flex_pts_sr.sv bit_stuff.sv Byte_Register.sv Encoder.sv byte_transmitter.sv txpu.sv CRC_Calculator.sv  transmitter.sv}
